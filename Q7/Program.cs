...
namespace Q7
{
    /*Write a Console Application program to simulate a basic ATM machine
     Allow the user to check balance, deposit money, and withdraw money
     Display appropriate messages based on user actions
     (Create separate functions for individual operations
     */
